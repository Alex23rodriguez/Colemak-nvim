...
local plugins = {
	...
	"jeetsukumaran/vim-indentwise",
	{
		...
		init = function()
			...
			vim.api.nvim_set_hl(0, "QuickScopePrimary", { fg = "#ffff00", underline = true, ctermfg = 155 })
			vim.api.nvim_set_hl(0, "QuickScopeSecondary", { fg = "#ff0000", underline = true, ctermfg = 81 })
		end,
	},
	"tpope/vim-surround",
