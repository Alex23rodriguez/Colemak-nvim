...
local function on_attach(bufnr)
	...
	vim.keymap.set("n", ";", api.fs.copy.relative_path, opts("Copy Relative Path"))
	...
	vim.keymap.set("n", "<C-u>", "", { buffer = bufnr })
	vim.keymap.del("n", "<C-u>", { buffer = bufnr })
	...
	vim.keymap.set("n", "a", api.fs.create, opts("Create"))
	vim.keymap.set("n", "y", api.fs.copy.filename, opts("Copy Name"))
	vim.keymap.set("n", "p", api.fs.copy.relative_path, opts("Copy Relative Path"))
	...
	vim.keymap.set("n", "Y", api.node.navigate.sibling.last, opts("Last Sibling"))
	vim.keymap.set("n", "H", api.tree.toggle_hidden_filter, opts("Toggle Dotfiles"))
	vim.keymap.set("n", "R", api.tree.reload, opts("Refresh"))
	vim.keymap.set("n", "<C-r>", api.fs.rename_sub, opts("Rename: Omit Filename"))
	vim.keymap.set("n", "x", api.fs.cut, opts("Cut"))
